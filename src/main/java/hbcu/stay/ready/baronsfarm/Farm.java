...
public class Farm {
    ...
    Farm(String farmName, List<Person> people, String stableName, ArrayList<Horse> horses, String coopName, ArrayList<Chicken> chickens, String fieldName) {
        this.name = farmName;
        this.farmHouse = new FarmHouse(people);
        this.stables = new Stables(stableName, horses);
        this.chickenCoop = new ChickenCoop(coopName, chickens);
        this.cropRows = new CropRow();
        this.field = new Field(fieldName, cropRows);
    }
